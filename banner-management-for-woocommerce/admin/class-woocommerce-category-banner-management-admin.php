...
class woocommerce_category_banner_management_Admin {
     ...
     * @since 1.0.0
     */
    public function wcbm_admin_footer_review() {
        $url = '';
        $url = esc_url( 'https://wordpress.org/plugins/banner-management-for-woocommerce/#reviews' );
        $html = sprintf( wp_kses( __( '<strong>We need your support</strong> to keep updating and improving the plugin. Please <a href="%1$s" target="_blank">help us by leaving a good review</a> :) Thanks!', 'banner-management-for-woocommerce' ), array(
            'strong' => array(),
            'a'      => array(
                'href'   => array(),
                'target' => 'blank',
    ...
    public function wcbm_product_cat_taxonomy_custom_fields( $tag ) {
        ...
        if ( taxonomy_exists( $current_taxonomy ) && term_exists( $t_id, $current_taxonomy ) ) {
            ...
            if ( !empty( $child_categories ) ) {
                ...
                ?><div class="wcbm-pro-label"></div></label>
						...
						<td class="auto_display">
							<fieldset>
								<input id="same_banner_for_child" name="term_meta[same_banner_for_child]" type="checkbox" value="on"
									class="same_banner_for_child" disabled />
								<label class="same_banner_for_child_label" for="same_banner_for_child"><em></em></label>
							</fieldset>
						</td>
					</tr>
					<?php 
        ...
        ?>
				...
				<td>
					<fieldset>
						<input id="cat_banner_start_date" name="term_meta[cat_banner_start_date]" type="text" value="" class="cat_banner_start_date" disabled />
        ...
        ?>
				...
				<td class="top_display">
					<fieldset>
						<input id="top_display_banner" name="term_meta[top_display_banner]" type="checkbox" value="on" class="top_display_banner" disabled />
