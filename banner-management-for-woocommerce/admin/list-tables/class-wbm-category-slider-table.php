...
/**
 * wcbm_banner_management_category_slider_Table class.
 *
 * @extends WP_List_Table
 */
if ( ! class_exists( 'wcbm_banner_management_category_slider_Table' ) ) {

	class wcbm_banner_management_category_slider_Table extends WP_List_Table {
		...
		public function column_shortcode( $item ) {
			$method_name = '<div class="wbm-after-copy-text"><span class="dashicons dashicons-yes-alt"></span> Shortcode  Copied to Clipboard! </div><input class="wbm-copy-shortcode" type="text" value="[wcbm_category id=&quot;'.$item->ID.'&quot;]" readonly="readonly">';
